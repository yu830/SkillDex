...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    summary: {
      en: "A Claude Code Skill for creating distinctive, production-grade frontend interfaces for components, pages, applications, and visual web artifacts.",
    ...
    compatibility: {
      tools: ["claude-code"],
      environments: ["Claude Code", "Frontend codebase or web UI artifact"],
      requirements: [
